...
\textbf{BrainTrace [2026]} is an online-learning system for spiking networks;
...
in the order of the letter, W1--W5 then Q1--Q2, and where a point recurs across
...
scale first --- the same gain degeneracy our $\mu_2$ anchor addresses (W5).
