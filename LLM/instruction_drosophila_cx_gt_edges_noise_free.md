...
3. Save it to `config/drosophila_cx/drosophila_cx_gt_edges_noise_free_winner.yaml` with a YAML comment header:

```yaml
# Winner config: drosophila_cx_gt_edges_noise_free_winner.yaml
...
Destination: `config/drosophila_cx/drosophila_cx_gt_edges_noise_free_winner.yaml`
