...
- DAVIS visual input, **noise_model_level=0.05 + 100% null edges per column** (structured sparsity)
...
Destination: `config/fly/fly_noise_005_null_edges_pc_100_known_ode_winner.yaml`
...
- Hypothesis: "Known ODE can learn connectivity under structured constraints despite 100% null edges per column"
...
```markdown
# Working Memory: flyvis_noise_005_null_edges_pc_100_known_ode
