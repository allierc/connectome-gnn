...
3. Save it to `config/zebrafish_oculomotor/zebrafish_oculomotor_noise_free_winner.yaml` with a YAML comment header:

```yaml
# Winner config: zebrafish_oculomotor_noise_free_winner.yaml
