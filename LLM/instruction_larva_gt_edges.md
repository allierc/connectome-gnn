...
3. Save it to `config/larva/larva_gt_edges_winner.yaml` with a YAML comment header:

```yaml
# Winner config: larva_gt_edges_winner.yaml
...
Destination: `config/larva/larva_gt_edges_winner.yaml`
