...
Summing over all 13,697 postsynaptic neurons gives the global null space estimate. At the 99\% threshold with noise-free data ($r_{\text{global}} = 45$), the null space is concentrated in high in-degree neurons:

\begin{center}
\begin{tabular}{lrr}
\toprule
In-degree range & Neurons & Null space contribution (rank 45) \\
\midrule
1--10   & 3,182 & 0 \\
11--20  & 3,917 & 0 \\
21--45  & 3,196 & 0 \\
...
101--208 & 559  & 50,773 \\
\midrule
\textbf{Total} & \textbf{13,697} & \textbf{115,223} \\
\bottomrule
\end{tabular}
\end{center}
