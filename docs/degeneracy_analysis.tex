...
\midrule
noise-free & 400 & 115,223 & \textbf{26.5\%} \\
noise-0.05 & 400 & 115,223 & \textbf{26.5\%} \\
noise-0.5 & 774 & 0 & \textbf{0.0\%} \\
\bottomrule
\end{tabular}
\end{center}

This is a conservative estimate because it assumes every neuron's rank is limited by the global rank, missing per-neuron stronger correlations. With strong noise (σ=0.5), the global rank (774) exceeds the maximum in-degree (208), making all weights identifiable.
...
The three approaches estimate degeneracy using different mechanisms but converge on a consistent picture. At the 99\% variance threshold, their estimates differ by a factor of 1.2--1.7x but all agree that the null space is substantial:
...
\midrule
Consensus range & 100--195K & \textbf{23--45\%} \\
\bottomrule
\end{tabular}
\end{center}
