...
\end{equation}
For the flyvis connectome (434,112 edges, 65 cell types), this yields a null space dimension of $\sim 121{,}100$ (approximately $28\%$ of all edges). Since each null direction scales continuously as $\boldsymbol{\delta} \to \lambda \boldsymbol{\delta}$, the solution set is an \textbf{uncountably infinite} $\sim 121{,}100$-dimensional manifold. This structural count agrees to within 5\% with the global SVD bound (115,223), validating both approaches and confirming that within-type degeneracy dominates.
