"""
Emit the TeX row for the Known-ODE-reg + 400% null edges condition, from
  <DATA_ROOT>/log/fly/flyvis_noise_005_null_edges_pc_400_known_ode_reg_winner/results/cv_summary.txt
...
LABEL     = '$+400\\%$ null edges'
CONFIG    = 'flyvis_noise_005_null_edges_pc_400_known_ode_reg_winner'
NOISE_SIG = '0.05'
NOISE_GAM = '0'
EDGES     = '2\\,170\\,560'
OUT_BASENAME = 'cv_known_ode_reg_null_edges_rows.tex'
