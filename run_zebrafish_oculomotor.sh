...
# Comprehensive batch run of all zebrafish_oculomotor LLM explorations
...
echo "=========================================="
echo "Zebrafish Oculomotor LLM Exploration Suite"
echo "=========================================="
echo "Running all 12 zebrafish_oculomotor configurations"
echo "Device: cuda:1"
...
python GNN_LLM.py -o generate_train_test_plot_Claude \
  --batch-configs \
    zebrafish_oculomotor_noise_free \
    zebrafish_oculomotor_noise_005 \
    zebrafish_oculomotor_noise_05 \
  --batch-iterations 84 \
  --cluster \
  --resume \
  --skip-confirm \
...
python GNN_LLM.py -o generate_train_test_plot_Claude \
  --batch-configs \
    zebrafish_oculomotor_gt_edges_noise_free \
    zebrafish_oculomotor_gt_edges_noise_005 \
    zebrafish_oculomotor_gt_edges_noise_05 \
  --batch-iterations 84 \
  --cluster \
  --resume \
  --skip-confirm \
...
python GNN_LLM.py -o generate_train_test_plot_Claude \
  --batch-configs \
    zebrafish_oculomotor_known_ode_noise_free \
    zebrafish_oculomotor_known_ode_noise_005 \
    zebrafish_oculomotor_known_ode_noise_05 \
  --batch-iterations 84 \
  --cluster \
  --resume \
  --skip-confirm \
...
python GNN_LLM.py -o generate_train_test_plot_Claude \
  --batch-configs \
    zebrafish_oculomotor_known_ode_gt_edges_noise_free \
    zebrafish_oculomotor_known_ode_gt_edges_noise_005 \
    zebrafish_oculomotor_known_ode_gt_edges_noise_05 \
  --batch-iterations 84 \
  --cluster \
  --resume \
  --skip-confirm \
...
# ============================================
echo "=========================================="
echo "✓✓✓ All Zebrafish Oculomotor Explorations Complete!"
echo "=========================================="
echo ""
...
echo "  • log/Claude_exploration/LLM_zebrafish_oculomotor*/"
echo "  • graphs_data/zebrafish_oculomotor/"
echo ""
