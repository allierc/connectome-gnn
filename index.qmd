...
::: {layout-ncol=2}
![**Fly.** The 338-cell central-complex path-integration circuit — the seven heading-core cell classes (EPG, EPG~t~, PEN~a~, PEN~b~, Δ7, PEG, ER6) plus the six fan-shaped-body columnar / vector families (PFN~d~, PFN~v~, PFN~a~, hΔB, PFR~a~, PFR~b~) — on the protocerebral bridge, ellipsoid body, fan-shaped body, noduli and bulb. The heading bump lives in the EB; PEN neurons inject angular velocity to rotate it.](figures/drosophila_cx/fig_cx_anatomy_3d.png)
