...
| arm | precision | n | one-step r | rollout r | fit roll cond | fit roll curr | R2_W | R2_tau | R2_Vrest | R2_Vrest noC | R2_msg | C_i | k_i | cluster |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| rtx6000 | fp32 | 1 | 0.998 ± 0.000 | 0.998 ± 0.000 | 0.990 ± 0.000 | 0.599 ± 0.000 | 0.948 ± 0.000 | 0.967 ± 0.000 | 0.806 ± 0.000 | 0.768 ± 0.000 | 0.978 ± 0.000 | 0.041 ± 0.000 |  | 0.898 ± 0.000 |
| rtx6000 | bf16 | 1 | 0.999 ± 0.000 | 0.998 ± 0.000 | 0.991 ± 0.000 | 0.551 ± 0.000 | 0.944 ± 0.000 | 0.965 ± 0.000 | 0.763 ± 0.000 | 0.745 ± 0.000 | 0.973 ± 0.000 | 0.038 ± 0.000 |  | 0.914 ± 0.000 |
| a100 | fp32 | 1 | 0.999 ± 0.000 | 0.998 ± 0.000 | 0.990 ± 0.000 | 0.591 ± 0.000 | 0.946 ± 0.000 | 0.987 ± 0.000 | 0.763 ± 0.000 | 0.784 ± 0.000 | 0.980 ± 0.000 | 0.040 ± 0.000 |  | 0.888 ± 0.000 |
| a100 | bf16 | 1 | 0.998 ± 0.000 | 0.998 ± 0.000 | 0.990 ± 0.000 | 0.647 ± 0.000 | 0.939 ± 0.000 | 0.934 ± 0.000 | 0.836 ± 0.000 | 0.732 ± 0.000 | 0.980 ± 0.000 | 0.047 ± 0.000 |  | 0.909 ± 0.000 |

### Running --- train split, `tmp_training/`, blank where not written per checkpoint

| arm | precision | iter | one-step r | rollout r | fit roll cond | fit roll curr | R2_W | R2_tau | R2_Vrest | R2_Vrest noC | R2_msg | C_i | k_i | cluster |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| — | | | | | | | | | | | | | | |
