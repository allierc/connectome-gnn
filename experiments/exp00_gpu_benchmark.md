...
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| rtx6000 | fp32 | 27,201 |  | 0.996 ± 0.000 | 0.921 ± 0.000 | 0.970 ± 0.000 | 0.698 ± 0.000 | 0.605 ± 0.000 | 0.959 ± 0.000 |  |  | 0.890 ± 0.000 |
| rtx6000 | bf16 | 30,401 |  | 0.996 ± 0.000 | 0.925 ± 0.000 | 0.964 ± 0.000 | 0.681 ± 0.000 | 0.627 ± 0.000 | 0.955 ± 0.000 |  |  | 0.901 ± 0.000 |
| a100 | fp32 | 16,001 |  | 0.995 ± 0.000 | 0.913 ± 0.000 | 0.912 ± 0.000 | 0.714 ± 0.000 | 0.565 ± 0.000 | 0.947 ± 0.000 |  |  | 0.931 ± 0.000 |
| a100 | bf16 | 1,281 |  | 0.936 ± 0.000 | 0.735 ± 0.000 | 0.093 ± 0.000 | 0.468 ± 0.000 | 0.264 ± 0.000 | 0.899 ± 0.000 |  |  |  |

### Per run

| run | status | iter | commit |
|---|---|---|---|
| `bench_rtx6000_fp32` | running | 28,801 | `` |
| `bench_rtx6000_bf16` | running | 30,401 | `bce608981ef9` |
| `bench_a100_fp32` | running | 17,601 | `` |
| `bench_a100_bf16` | running | 1,601 | `` |
