...
# bsub -n 2 -gpu "num=1" -q ${CLUSTER_QUEUE_PREFIX}a100 -W 6000 -Is "python GNN_Main.py -o train $CLUSTER_HOME/Graph/connectome-gnn/config/fly/flyvis_noise_005_stride_5"
# bsub -n 2 -gpu "num=1" -q ${CLUSTER_QUEUE_PREFIX}h100 -W 6000 -Is "python GNN_Main.py -o train_test_plot $CLUSTER_HOME/Graph/connectome-gnn/config/fly/flyvis_noise_005_hidden_005"
# bsub -n 2 -gpu "num=1" -q ${CLUSTER_QUEUE_PREFIX}h100 -W 6000 -Is "python GNN_Main.py -o train_test_plot $CLUSTER_HOME/Graph/connectome-gnn/config/fly/flyvis_noise_005_hidden_010 --output_root $GNN_OUTPUT_ROOT"
