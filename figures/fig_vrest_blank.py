...
FS_TITLE  = 17        # panel subtitle (scatter panels)
...
# Build figure — 1×4
# ---------------------------------------------------------------------------
fig, axes = plt.subplots(1, 4, figsize=(27.0, 6.0), dpi=300,
...
for vals, key, col in metric_series:
    ax_c.plot(pcts, vals, marker='o', markersize=MARKER_S, linewidth=LW, color=col, label=key)
...
ax_d.plot(pcts_r, rollout, marker='o', markersize=MARKER_S, linewidth=LW, color='#9467bd')
