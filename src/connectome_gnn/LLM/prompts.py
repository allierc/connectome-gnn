...
2. Look at the connectivity matrix heatmap in tmp_training/Wij/connectivity_*.png — compare GT vs learned W visually. Note in your log entry: is the learned W sparse enough? Are signs correct? Is the structure emerging?
