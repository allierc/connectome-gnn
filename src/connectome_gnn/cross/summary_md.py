...
def _collect_fold(fold_dir):
    ...
    return {
        ...
        'W_R2':              m.get('Wij_R2',                    float('nan')),
        'W_R2_full':         m.get('Wij_R2_all',                float('nan')),
        'W_slope':           m.get('Wij_slope',                 float('nan')),
        # Stored as raw fractions; multiply by 100 for the % display columns.
        'W_rel_err_med_pct':  100.0 * m['Wij_rel_err_median'] if 'Wij_rel_err_median' in m else float('nan'),
        'W_rel_err_iqr_pct':  100.0 * m['Wij_rel_err_iqr']    if 'Wij_rel_err_iqr'    in m else float('nan'),
        'tau_R2':             m.get('tau_R2_all',            float('nan')),
        'tau_R2_clean':       m.get('tau_R2',                float('nan')),
        ...
        'V_rest_R2':          m.get('V_rest_R2_all',             float('nan')),
        'V_rest_R2_clean':    m.get('V_rest_R2', float('nan')),
