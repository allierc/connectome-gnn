...
@register_ode_params("flyvis_conductance_twin")
@dataclass
class FlyVisConductanceODEParams(FlyVisCurrentODEParams):
    ...
    Registered under `flyvis_conductance_twin`, NOT `flyvis_conductance`. That
    name is already taken by the conductance-style GNN, which is a MODEL that
    trains on current-generated data; this describes data GENERATED by the
    conductance twin. Model and generator are different axes.
