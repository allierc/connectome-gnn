...
# under the NFS-mounted Graph/ tree which is reachable from $CLUSTER_SSH):
#   ssh $CLUSTER_SSH "bash -l -c 'bash /groups/saalfeld/home/allierc/Graph/connectome-gnn/run_generate_flywireRF_zeroedge_LLM_data.sh'"
#
