...
run_all_conditions(
    ...
    # Default HP yaml is irrelevant here because every base has an entry in
    # HP_YAML_OVERRIDES; we still pass one (matches the e8 base) so the
    # uniform-mode path has something to fall back to if the dict is edited.
