...
![**Anatomy of the 156 CX neurons and the flow of heading information.** (a) 3-D skeleton render of the seven cell classes over PB, FB, EB, NO and bulb; colours identify cell types and are used consistently throughout. (b) Soma locations: cell bodies lie outside the neuropils, so the ring visible in the EB is a ring of *arborisations*, not of somata.](figures/drosophila_cx/fig_cx_anatomy_3d.png)

![**The CX connectome $W^{\mathrm{con}}$.** (a) Signed connectome, z-scored over non-zero entries (red excitatory, blue inhibitory). (b) Binary support — sparse, density 0.42, 10 263 non-zero edges out of $156^2 = 24\,336$. (c,d) Per-cell-type incoming/outgoing edge-weight distributions; Dale's law appears as one-sided outgoing violins — every type excitatory except Δ7 and ER6. Following the Hulse-2025 preparation, Δ7 and ER6 outputs are sign-flipped (inhibitory) and ER6 amplified 5× before $W^{\mathrm{con}}$ is normalised to spectral radius 0.9.](figures/drosophila_cx/fig_connectome_summary.png)
